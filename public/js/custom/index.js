...
function getAppointmentNum(start, end){
    return new Promise(function(resolve, reject){
        let query = "";
        if(start)
            query = "?query=date&start="+start+"&end="+end;
...
function init_daterangepicker() {
    ...
    $('#reportrange').on('apply.daterangepicker', async function(ev, picker) {
        const num = await getAppointmentNum(new Date(picker.startDate), new Date(picker.endDate));
        console.log(num);
    });
...
window.onload = async function () {
    ...
    const apMonthNum = await getAppointmentNum(firstDay, lastDay);
